...
VALUES
    ('Apple', 'Jesteśmy innowacyjną firmą z tradycjami, tworzymy oprogramowanie od ponad 20 lat', 'Wrocław', 100,
     '48 123-234-345', 'kontakt@appul.xyz'),
    ('Google', 'Lider w branży oprogramowania dla małych i średnich firm', 'Warszawa', 300,
